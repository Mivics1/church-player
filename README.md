...
- **Input form (n8n):** https://agbooladaramola7.n8n-wsk.com/form/church-setup
- **Player (this site):** https://mivics1.github.io/church-player/
...
```
https://mivics1.github.io/church-player/?video=<URL>&logo=<URL>&logoSec=3&ghs=<start>-<end>&choir=<start>-<end>&gs=<start>-<end>
```
